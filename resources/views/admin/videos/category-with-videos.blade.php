      ...
      <div class="both-sections-container d-lg-flex ">
        ...
        <div class="section-one mt-5 mb-0">
          ...
          <div class="row mt-1 featured-videos">
            ...
            @if($getVideosByCategory->count() > 0)
            @foreach($getVideosByCategory as $index => $values)
            ...
            <div class="col-12 mt-2">
              {{ $getVideosByCategory->links() }}
            </div>

            @else
            <div class="col-12 mt-5">
              <span class="mt-5 text-center">
                <span class="text-center text-capitalize bg-dark text-white py-3 px-5 rounded-pill">
                  No Videos Related to this category.
                </span>
              </span>
            </div>
            @endif
