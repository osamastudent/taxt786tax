...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-s text-capitalizecale=1.0">  
    <title>Update Alert This Popup will be shown after Addind to cart</title>
    <style>
    .card{
...
<h4>Update Alert This Popup will be shown after Addind to cart</h4>
</div>
<div class="card-body">
    @if(session('success'))
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    @endif
<form action="{{route('AlertFormSubmitUpdateStore')}}" method="post" class="p-4">
    @csrf
