    ...
    <div id="blog-posts-container">
      ...
      <div class="both-sections-container d-lg-flex ">
        ...
        <div class="section-one mb-0">
          ...
          @if($getPostsByCategory->homeBlogPostR->count() > 0)
          @foreach($getPostsByCategory->homeBlogPostR as $values)
          <div class="card mt-1 load-more-posts border-0">
            <!-- row start -->
            <div class="row">
              <!-- column start -->
                <div class="col-12">
                  <div class="card-title">
                    ...
                    <a href="/bindclick/{{ $values->blog_title . '/' . $values->id }}" class="text-decoration-none text-dark" target="_blank">
                      <h2 class="blog-name">{{$values->blog_title}}</h2>
                    </a>

                    <a href="/bindclick/{{ $values->blog_title . '/' . $values->id }}" class="text-decoration-none text-dark" target="_blank">
                      <h2 class="blog-name">{{$getPostsByCategory->name}}</h2>
                    </a>
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-5">
                ...
                <a href="/bindclick/{{ $values->blog_title . '/' . $values->id }}" class="text-decoration-none text-dark" target="_blank">
                  ...
                  <a href="/bindclick/{{ $values->blog_title . '/' . $values->id }}" class="text-decoration-none text-dark" target="_blank">
                    <img src="{{asset('homepageblogs/'.$values->blog_image)}}" class="recentblog-imae " height="200px" width="100%" alt="image">
                  </a>
              ...
              <div class="card-body mt-0 bg-light">
                ...
                <ul class="list-group border-0 bg-light">
                  ...
                  <li class="list-group-item categories-name border-start-0 border-end-0 bg-light">
                    <a href="{{url('posts-by-category/'.$blogCategoryValues->id)}}" class="categories-name">{{ $blogCategoryValues->name }}</a>
                  </li>
                  @endforeach
                </ul>
