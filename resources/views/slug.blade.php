...
<div class="input-group w-50" style="float: right; border-radius:5px">
  <input type="text" name="search" class="form-control " id="searchId" onkeyup="Search()" placeholder="Search...">
    ...
    <div class="both-sections d-lg-flex">
      ...
      <div class="section-one">
        ...
        <li class="nav-item mt-3" role="presentation">
            <button class="nav-link active p-2" id="specific-tab" data-bs-toggle="tab" data-bs-target="#specific" type="button" role="tab" aria-controls="true" aria-selected="false">Specific</button>
          </li>


          <li class="nav-item mt-3 " role="presentation">
            <button class="nav-link p-2" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab" aria-controls="all" aria-selected="false">All</button>
          </li>



          <li class="nav-item mt-3" role="presentation">
            <button class="nav-link p-2" id="incometaxt-tab" data-bs-toggle="tab" data-bs-target="#incometaxt" type="button" role="tab" aria-controls="incometaxt" aria-selected="false">Income Tax Return</button>
          </li>

          <li class="nav-item mt-3" role="presentation">
            <button class="nav-link p-2" id="salestax-tab" data-bs-toggle="tab" data-bs-target="#salestax" type="button" role="tab" aria-controls="salestax" aria-selected="false">Sales Tax Registration</button>
          </li>
          <li class="nav-item mt-3" role="presentation">
            <button class="nav-link p-2" id="company-tab" data-bs-toggle="tab" data-bs-target="#company" type="button" role="tab" aria-controls="company" aria-selected="false">Company's Registration</button>
          </li>
          <li class="nav-item mt-3" role="presentation">
            <button class="nav-link p-2" id="intellectual-tab" data-bs-toggle="tab" data-bs-target="#intellectual" type="button" role="tab" aria-controls="intellectual" aria-selected="false">intellectual Property</button>
          </li>

          <li class="nav-item mt-3" role="presentation">
            <button class="nav-link p-2" id="LLC-tab" data-bs-toggle="tab" data-bs-target="#LLC" type="button" role="tab" aria-controls="LLC" aria-selected="false">USA LLC & Tax Filling</button>
          </li>
        </ul>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="col-6">
                    ...
                    <h6 class="searchHeading">{{$matchData->title}}</h5>
                  </div>

                  <div class="col-6 text-end">
                    <p class="d-inline ntn-tab-right-content justify-content-end">Manufacturer: Rs. {{number_format($matchData->price)}}</p>
                ...
                <p>{{$matchData->requirement}}</p>
                <ul class="text-start px-2">
                  @if($matchData->text_one)
                  <li>{{$matchData->text_one}}</li>
                  @else
                  @endif

                  @if($matchData->text_two)
                  <li>{{$matchData->text_two}}</li>
                  @else
                  @endif

                  @if($matchData->text_three)
                  <li>{{$matchData->text_three}}</li>
                  @else
                  @endif


                  @if($matchData->text_four)
                  <li>{{$matchData->text_four}}</li>
                  @else
                  @endif


                  @if($matchData->text_five)
                  <li>{{$matchData->text_five}}</li>
                  @else
                  @endif
                  @if($matchData->text_six)
                  <li>{{$matchData->text_six}}</li>
                  @else
                  @endif
                  @if($matchData->text_seven)
                  <li>{{$matchData->text_seven}}</li>
                  @else
                  @endif

                  @if($matchData->text_eight)
                  <li>{{$matchData->text_eight}}</li>
                  @else
                  @endif
                  @if($matchData->text_nine)
                  <li>{{$matchData->text_nine}}</li>
                  @else
                  @endif
                  @if($matchData->text_ten)
                  <li>{{$matchData->text_ten}}</li>
                  @else
                  @endif
                  @if($matchData->text_eleven)
                  <li>{{$matchData->text_eleven}}</li>
                  @else
                  @endif
                  @if($matchData->text_twelve)
                  <li>{{$matchData->text_twelve}}</li>
                  @else
                  @endif
                  @if($matchData->text_thirteen)
                  <li>{{$matchData->text_thirteen}}</li>
                  @else
                  @endif
                  @if($matchData->text_fourteen)
                  <li>{{$matchData->text_fourteen}}</li>
                  @else
                  @endif

                  @if($matchData->text_fifthteen)
                  <li>{{$matchData->text_fifthteen}}</li>
                  @else
                  @endif
                  @if($matchData->text_sixteen)
                  <li>{{$matchData->text_sixteen}}</li>
                  @else
                  @endif
                  @if($matchData->text_seventeen)
                  <li>{{$matchData->text_seventeen}}</li>
                  @else
                  @endif
                  @if($matchData->text_eighteen)
                  <li>{{$matchData->text_eighteen}}</li>
                  @else
                  @endif

                  @if($matchData->text_nineteen)
                  <li>{{$matchData->text_nineteen}}</li>
                  @else
                  @endif

                  @if($matchData->text_twenty)
                  <li>{{$matchData->text_twenty}}</li>
                  @else
                  @endif
                </ul>
                ...
                <div class=" bd-highlight ">
                  ...
                  <!-- Button trigger modal -->
                    ...
                    <button type="button" class="btn request-for-call" data-bs-toggle="modal" data-bs-target="#statictwoBackdrop{{$matchData->id}}">
                      Request For Call
                    </button>

                    <!-- Modal -->
                    <div class="modal p-4 fade" id="statictwoBackdrop{{$matchData->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel{{$matchData->id}}" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel{{$matchData->id}}">Have queries?
                          ...
                          <div class="modal-body">
                            ...
                            <form action="{{route('requestForCall')}}" method="post" class="px-4 pb-3 pt-1 mt-0 mb-2">
                              ...
                              <input type="text" name="queries" class="form-control" value="{{$matchData->title}}" placeholder="Enter Queries">
