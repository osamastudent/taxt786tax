  ...
  <div class="container">
    ...
    <div class="card mt-4 w-75 mx-auto">
      <div class="card-header bg-dark text-light text-center">
        <h5>RENT TAX CALCULATOR-2023-2024</h5>
      </div>
      <div class="card-body">
      ...
      <div class="row">
        ...
        <form action="{{route('rentTaxCalculationStore')}}" method="post" class=" ">
          @csrf
...
<!-- table overflow-div end -->
  ...
  <div class="col-12  text-center">
        ...
        <a href="{{route('rentTaxCalculation')}}" class="btn mt-3 btn-style-active">RENT TAX CALCULATOR-2023-2024</a>
