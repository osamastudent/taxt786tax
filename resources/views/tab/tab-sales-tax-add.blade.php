...
<head>
    ...
    <title>Add Sales Tax Registration</title>
    <style>
        .card {
    ...
    <div class="container">
        ...
        <div class="card mx-auto mt-5">
            <div class="card-header bg-dark text-light">
                <h4>Add Sales Tax Registration</h4>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                @endif
                <form action="{{route('tabSalesTaxStore')}}" method="post" class="p-4">
                    @csrf
                    ...
                    <br>
                    <input type="submit" class="btn btn-dark text-light mt-3" value="Add Sales Tax Registration">
