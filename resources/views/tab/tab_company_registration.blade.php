...
<head>
    ...
    <title>Add Income Tax Return</title>
    <style>
        .card {
    ...
    <div class="container">
        ...
        <div class="card mx-auto mt-5">
            <div class="card-header bg-dark text-light">
                <h4>Add tab Company Registration</h4>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                @endif
                <form action="{{route('tabCompanyRegistrationStore')}}" method="post" class="p-4">
                    @csrf
                    ...
                    <br>
                    <input type="submit" class="btn btn-dark text-light mt-3" value="Add Tab Company Registration">
