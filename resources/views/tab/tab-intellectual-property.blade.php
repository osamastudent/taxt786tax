...
<head>
    ...
    <title>Add Tab Intellectual Property</title>
    <style>
        .card {
    ...
    <div class="container">
        ...
        <div class="card mx-auto mt-5">
            <div class="card-header bg-dark text-light">
                <h4>Add Intellectual Property</h4>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                @endif
                <form action="{{route('intellectualPropertyStore')}}" method="post" class="p-4">
                    @csrf
                    ...
                    <br>
                    <input type="submit" class="btn btn-dark text-light mt-3" value="Add Tab Intellectual Property">
