  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="card w-75 mx-auto border-0">
      ...
      <div class="card-body px-5 mt-3">
        ...
        <form action="{{route('IndividualStore')}}" method="post" class=" mb-3" enctype="multipart/form-data">

        @csrf
        <strong>Documents Required (for Individual)</strong>
          <div class="row">
          ...
          <div class="filesContainer" id="filesContainer">
            <div class="row" id="cloneData">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">Copy of NTN</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group ll ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image" name="copy_ntn[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder" name="copy_ntn[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer2" id="filesContainer2">
            <div class="row" id="cloneData2">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1">Copy of CNIC</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image2" name="copy_cnic[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder2" name="copy_cnic[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
...
<!-- row end -->
          ...
          <div class="filesContainer3" id="filesContainer3">
            <div class="row" id="cloneData3">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-3 mb-1">Paid Electricity Bill
                </label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image3" name="paid_electricity_bill[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder3" name="paid_electricity_bill[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer4" id="filesContainer4">
            <div class="row" id="cloneData4">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label  mb-1">Tenancy Agreement along with owner CNIC or Ownership </label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" name="tenancy_agreement_ownership[]" class="custom-file-input  w-100" id="input-image4" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" name="tenancy_agreement_ownership[]" class="custom-folder-input w-100" id="uploadfolder4" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer5" id="filesContainer5">
            <div class="row" id="cloneData5">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-3 mb-1">Documents of Business Premises</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image5" name="documents_business_premises[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder5" name="documents_business_premises[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image6" name="bank_maintenance_certificate[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder6" name="bank_maintenance_certificate[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
...
@endif
  ...
  <script src="/javascriptfiles/individual.js"></script>
  <script src="/addnewfiles/individual-add.js"></script>
</body>
