...
<head>
  ...
  <title>Income Tax Filing Partnership & Company</title>
  <style>
    .add-new-file {
  ...
  <div class="container  mt-5 mb-5">
    ...
    <div class="card w-75 mx-auto border-0">
      ...
      <div class="card-header bg-dark text-white">
        <h3>Income Tax Filing – Partnership & Company</h3>
      </div>
      <div class="card-body px-5 mt-3">

        <form action="{{route('PartnershipCompanyStore')}}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="filesContainer" id="filesContainer">
            <div class="row" id="cloneData">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">Bank Statement of all banks from 1 july to 30 june (Multiple documents Attach or Capture)</label>
                ...
                <div class="dropdown" id="dropdown1">
                  <button class="text-start form-control text-truncate personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    Bank Statement of all banks from 1 july to 30 june (Multiple documents Attach or Capture)
          ...
          <div class="filesContainer2" id="filesContainer2">
            <div class="row" id="cloneData2">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">Financial Statements & accounts if any (Multiple documents Attach or Capture)</label>
                ...
                <div class="dropdown" id="dropdown2">
                  <button class="text-start form-control personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                    Financial Statements & accounts if any (Multiple documents Attach or Capture)
                  </button>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image2" name="financial_statement[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder2" name="financial_statement[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer3" id="filesContainer3">
            <div class="row" id="cloneData3">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">Business Assets details (Multiple documents Attach or Capture)</label>
                ...
                <div class="dropdown" id="dropdown3">
                  <button class="text-start form-control personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                    Business Assets details (Multiple documents Attach or Capture)
                  </button>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image3" name="business_assets[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder3" name="business_assets[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
            ...
            <div class="row ">
              ...
              <div class="col-12 col-lg-8 text-end">
                <button type="button" id="AddNewFile3" class="btn mt-2 btn-danger add-new-file">Add New File</button>
              </div>
