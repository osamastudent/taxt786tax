  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="card  mx-auto border-0 w-75">
      ...
      <div class="card-header bg-dark text-white">
        <h3> Sales Taxation </h3>
      </div>
      <div class="card-body  mt-3">

      <form action="{{route('SalesTaxationStore')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!-- row start -->
          <div class="row">
          ...
          <div class="row ">
            ...
            <div class="col-12 col-lg-4">
              <label for="" class="form-label mb-1">Phone Number</label>
            ...
            <div class="col-12 col-lg-12 ">
              ...
              <textarea name="address" id="" cols="30" rows="3" class=" form-control personal-ntn-bottom-borders  " placeholder="Address"></textarea>
              @error('address')
                            <span class="text-danger error-style">
                                <i class="fas fa-exclamation-triangle"></i>
                                {{$message}}
            ...
            <div class="col-12 col-lg-6">
              <label for="" class="form-label mt-3 mb-1">Tax ID Number</label>
              <input type="text" name="tax_id_number" class=" form-control personal-ntn-bottom-borders  " placeholder="Tax ID Number">
              @error('tax_id_number')
                            <span class="text-danger error-style">
                                <i class="fas fa-exclamation-triangle"></i>
                                {{$message}}
            ...
            <div class="col-12 col-lg-6">
              <label for="" class="form-label mt-3 mb-1">Business Type</label>
              <input type="text" name="business_type" class=" form-control personal-ntn-bottom-borders  " placeholder="Business Type">
              @error('business_type')
                            <span class="text-danger error-style">
                                <i class="fas fa-exclamation-triangle"></i>
                                {{$message}}
 ...
 <div class="row">
   ...
   <div class="filesContainer" id="filesContainer">
            <div class="row" id="cloneData">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label  mb-1"> Sales Receipts</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group ll ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image" name="sales_receipts[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder" name="sales_receipts[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer2" id="filesContainer2">
            <div class="row" id="cloneData2">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1"> Invoices</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image2" name="invoices[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder2" name="invoices[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer3" id="filesContainer3">
            <div class="row" id="cloneData3">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1">Other Documents That Show The Total Amount Of Sales Made in Each State
                </label>
                ...
                <div class="dropdown" id="dropdown3">
                  <button class="text-start form-control personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                    Other Documents That Show The Total Amount Of Sales Made in Each State
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image3" name="other_documents[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder3" name="other_documents[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="row ">
            <div class="col-12 mt-3">
              <label for="" class="form-label mt-0 mb-1">Any Exemptions Or Exclusions That Apply To The Business, Such as Sales To Tax-Exempt Organizations Or Sales Of Certain Products.</label>
              <input type="text" name="any_exemptions_exclusions" class=" form-control personal-ntn-bottom-borders" >
              @error('any_exemptions_exclusions')
                            <span class="text-danger error-style">
                                <i class="fas fa-exclamation-triangle"></i>
                                {{$message}}
                            </span>
...
@endif
  ...
  <script src="/javascriptfiles/sales-taxation.js"></script>
  <script src="/addnewfiles/sales-taxation-add.js"></script>
</body>
