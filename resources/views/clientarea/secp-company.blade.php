...
<head>
  ...
  <link rel="stylesheet" href="allcss/add-tag-input-box.css">
  <title>SECP Company Formation</title>
  ...
  <div class="container  mt-5 mb-5">
    ...
    <div class="card w-75 mx-auto border-0">
      ...
      <div class="card-header bg-dark text-white">
        <h3>SECP Company Formation</h3>
      </div>
      <div class="card-body ">

        <form action="{{route('SECPCompanyStore')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!-- row start -->
          <div class="row mt-2">
            <div class="col-12 col-lg-6">
              <label for="" class="form-label ">Type of registration</label>
              <select name="type_registraion" class="form-select personal-ntn-bottom-border-select " aria-label="Default select example " style="background-color: transparent; position: relative; z-index: 2;">
                <option selected value="">Type of registration</option>
            ...
            <div class="col-12 col-lg-6">
              <label for="" class="form-label">Suggested Names (comma-separated)</label>
              <input type="text" name="suggested_name[]" id="tag-input1" class="form-control personal-ntn-bottom-borders ">
              @error('suggested_name')
              <span class="text-danger">
                <i class="fas fa-exclamation-triangle"></i>
                {{$message}}
              </span>
          ...
          <div class="filesContainer" id="filesContainer">
            <div class="row" id="cloneData">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">NIC Front Back of all partners</label>
                ...
                <div class="dropdown" id="dropdown1">
                  <button class="text-start form-control text-truncate personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    NIC Front Back of all partners
                  </button>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group ll ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image" name="nic_front_back[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder" name="nic_front_back[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer2" id="filesContainer2">
            <div class="row" id="cloneData2">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1">Blood Relative CNIC</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image2" name="blood_relative_cnic[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder2" name="blood_relative_cnic[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-6">
              <label for="" class="form-label mt-3 mb-1 ">email registered on their CNIC of all Partners</label>
              <input type="text" name="email_registered_cnic" class="form-control personal-ntn-bottom-borders ">
            ...
            <div class="col-12 col-lg-6">
              <label for="" class="form-label mt-3 mb-1 ">Mobile number registered on their CNIC of all Partners</label>
              <input type="text" name="mobile_no_registered_cnic" class="form-control personal-ntn-bottom-borders ">
            ...
            <div class="col-12">
              <label for="" class="form-label mt-2">Company Address</label>
              <textarea name="company_address" id="" cols="30" rows="3" class="form-control personal-ntn-bottom-borders "></textarea>
            ...
            <div class="col-12">
              <label for="" class="form-label mt-3">Business Description</label>
              <textarea name="business_description" id="" cols="30" rows="3" class="form-control personal-ntn-bottom-borders "></textarea>
          ...
          <div class="filesContainer5" id="filesContainer5">
            <div class="row" id="cloneData5">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-3 mb-1">Witness 1 CNIC</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image5" name="witness_one_cnic[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder5" name="witness_one_cnic[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer6" id="filesContainer6">
            <div class="row" id="cloneData6">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1">Witness 2 CNIC</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image6" name="witness_two_cnic[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder6" name="witness_two_cnic[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
...
@endif
  ...
  <script src="/add-tag-input-box.js"></script>
</body>
