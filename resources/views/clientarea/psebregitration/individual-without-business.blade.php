...
<head>
    ...
    <title>Individual Without Business Name</title>
    <style>
         .add-new-file {
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card w-75 mx-auto border-0">
            ...
            <div class="card-header bg-dark text-white">
                <h3> Individual Without Business Name</h3>
            </div>
            <div class="card-body px-5 mt-3">


                <form action="{{route('individualWithOutBusinessNameStore')}}" method="post" class=" mb-3" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="filesContainer" id="filesContainer">
                        <div class="row" id="cloneData">
                            ...
                            <div class="col-12 col-lg-12">
                                <label for="" class="form-label mt-3 mb-1">Personal NTN (With No Business Name)</label>
                                ...
                                <div class="dropdown" id="dropdown1">
                                    <button class="text-start form-control personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        Personal NTN (With No Business Name)
                                    </button>
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <div class="input-group ll ">
                                                    <div class="custom-file form-control  border-0 ml-0">
                                                        <label class="input-group-text l2 mx-0 d-inline-block border-0  upload-file-label mr-0 p-0  " for="input-image"><img src="{{asset('filefolderuploadicon/fileuploadicon.png')}}" class="upload-file-icon" height="14"></label>
                                                        <input type="file" class="custom-file-input  w-100" id="input-image" name="personal_ntn[]" multiple>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <div class="input-group input-group-copy ">
                                                    <div class="custom-folder form-control  l3 border-0 ml-0">
                                                        ...
                                                        <input type="file" class="custom-folder-input w-100" id="uploadfolder" name="personal_ntn[]" multiple webkitdirectory folder>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                    ...
                    <div class="filesContainer2" id="filesContainer2">
                        <div class="row" id="cloneData2">
                            ...
                            <div class="col-12 col-lg-12">
                                <label for="" class="form-label mt-3 mb-1">CNIC (Both Sides)</label>
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <div class="input-group  ">
                                                    <div class="custom-file form-control  l3 border-0 ml-0">
                                                        ...
                                                        <input type="file" class="custom-file-input  w-100" id="input-image2" name="cnic_both_sides[]" multiple>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <div class="input-group input-group-copy ">
                                                    <div class="custom-folder form-control  l3 border-0 ml-0">
                                                        ...
                                                        <input type="file" class="custom-folder-input w-100" id="uploadfolder2" name="cnic_both_sides[]" multiple webkitdirectory folder>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
          ...
          <div class="filesContainer3" id="filesContainer3">
            <div class="row" id="cloneData3">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1">Personal Bank Account Letter/Certificate
                </label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image3" name="personal_bank_account_letter_certificate[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder3" name="personal_bank_account_letter_certificate[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
                ...
                @error('personal_bank_account_letter_certificate')
...
@endif
    ...
    <script src="/javascriptfiles/individual-without-business.js"></script>
    <script src="/addnewfiles/individual-without-business-add.js"></script>
</body>
