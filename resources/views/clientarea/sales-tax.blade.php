...
<head>
  ...
  <title>Sales Tax Monthly Filing</title>
  <style>
      .add-new-file {
  ...
  <div class="container  mt-5 mb-5">
    ...
    <div class="card w-75 mx-auto border-0">
      ...
      <div class="card-header bg-dark text-white">
        <h3>Sales Tax Monthly Filing</h3>
      </div>
      <div class="card-body px-5 mt-3">

        <form action="{{route('SalesTaxStore')}}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row mt-2">
            <div class="col-4">
              <select name="select_authority" class="form-select personal-ntn-bottom-border-select " aria-label="Default select example " style="background-color: transparent; position: relative; z-index: 2;">
                <option selected value=""><span class="text-warning">Select Authority</span></option>
            ...
            <div class="col-4">
              <select name="select_year" class="form-select personal-ntn-bottom-border-select " aria-label="Default select example " style="background-color: transparent; position: relative; z-index: 2;">
            ...
            <div class="col-4">
              <select name="select_month" class=" form-select personal-ntn-bottom-border-select " aria-label="Default select example " style="background-color: transparent;  position: relative; z-index: 2;">
          ...
          <div class="filesContainer" id="filesContainer">
            <div class="row" id="cloneData">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">Upload Purchase Invoices</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group ll ">
                          <div class="custom-file form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image" name="upload_purchase_invoices[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder" name="upload_purchase_invoices[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
                ...
                @error('upload_purchase_invoices.*')
                <span class="text-danger error-style">
                  <i class="fas fa-exclamation-triangle"></i>
                  {{$message}}
                </span>
          ...
          <div class="filesContainer2" id="filesContainer2">
            <div class="row" id="cloneData2">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">Upload Sales Invoices</label>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image2" name="upload_sales_invoices[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder2" name="upload_sales_invoices[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer3" id="filesContainer3">
            <div class="row" id="cloneData3">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-4 mb-1">Upload Sales / Purchase sheet (Download Sample Template)</label>
                ...
                <div class="dropdown" id="dropdown3">
                  <button class="text-start form-control personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                    Upload Sales / Purchase sheet (Download Sample Template)
                  </button>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image3" name="purchase_sheet[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control  l3 border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder3" name="purchase_sheet[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
