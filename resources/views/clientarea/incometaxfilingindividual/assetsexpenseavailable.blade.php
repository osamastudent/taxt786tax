...
<head>
  ...
  <title>Select Assets/expense available from list</title>
  <style>
    .add-new-file {
  ...
  <div class="container mt-5 mb-5">
    <div class=" card form-card mx-auto border-0">
      <div class="card-header bg-dark text-white">
        <h3>Select Assets/expense available from list</h3>
      </div>
      <div class="card-body px-5 mt-3">
        ...
        <!-- <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#" onclick="goBack(event)">{{ session()->get('salaryincomename') }}</a></li>
            @endif
            @if(session()->has('rentincomename'))
            <li class="breadcrumb-item"><a href="#" onclick="goBack(event)"> {{ session()->get('rentincomename') }}</a></li>
            @endif

            @if(session()->has('businessincomename'))
            <li class="breadcrumb-item"><a href="#" onclick="goBack(event)"> {{ session()->get('businessincomename') }}</a></li>
            @endif

            @if(session()->has('sharescapitalgainname'))
            <li class="breadcrumb-item"><a href="#" onclick="goBack(event)"> {{ session()->get('sharescapitalgainname') }}</a></li>
            @endif

            @if(session()->has('otherincomename'))
            <li class="breadcrumb-item"><a href="#" onclick="goBack(event)"> {{ session()->get('otherincomename') }}</a></li>
            @endif

            @if(session()->has('withholdingadjustablename'))
            <li class="breadcrumb-item"><a href="#" onclick="goBack(event)"> {{ session()->get('withholdingadjustablename') }}</a></li>
            @endif
            <li class="breadcrumb-item active" aria-current="page">Select Assets expense available from list</li>
          </ol>
        </nav> -->
        ...
        <!-- <div class="row">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#" onclick="goBack(event)">Salary Income</a></li>
              <li class="breadcrumb-item active" aria-current="page">Select Assets/expense available from list</li>
            </ol>
          </nav>
          @endif
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Rent Income</a></li>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Business Income</a></li>
              <li class="breadcrumb-item active" aria-current="page">Data</li>
            </ol>
          </nav>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Shares – Capital gain</a></li>
            </ol>
          </nav>
          @endif
          @if(session()->has('otherincomename'))
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Withholding / Adjustable or Final Tax</a></li>
            </ol>
          </nav>
          @endif
        ...
        <form action="{{route('AssetsExpenseAvailableStore')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!-- row start -->
          ...
          <div class="filesContainer mt-0 " id="filesContainer">
            <div class="row" id="cloneData">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1">Bank Statements from 1 july to 30 june of all banks (Multiple documents Attach or Capture)</label>
                ...
                <div class="dropdown" id="dropdown1">
                  <button class="text-start form-control text-truncate personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    Bank Statements from 1 july to 30 june of all banks (Multiple documents Attach or Capture)
                  </button>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group ll ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image" name="bank_statement[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder" name="bank_statement[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="filesContainer2" id="filesContainer2">
            <div class="row" id="cloneData2">
              ...
              <div class="col-12 col-lg-12">
                <label for="" class="form-label mt-0 mb-1">Properties Purchased or sold during the year (Multiple documents Attach or Capture)</label>
                ...
                <div class="dropdown" id="dropdown2">
                  <button class="text-start form-control personal-ntn-bottom-border-select btn text-truncate dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                    Properties Purchased or sold during the year (Multiple documents Attach or Capture)
                  </button>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group  ">
                          <div class="custom-file form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-file-input  w-100" id="input-image2" name="properties_purchased[]" multiple>
                          </div>
                        </div>
                      </a>
                    </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="input-group input-group-copy ">
                          <div class="custom-folder form-control   border-0 ml-0">
                            ...
                            <input type="file" class="custom-folder-input w-100" id="uploadfolder2" name="properties_purchased[]" multiple webkitdirectory folder>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="row">
            <div class="col-12 col-6">
              <label for="" class="form-label mb-1 mt-4 ">Prize Bond (Number)</label>
              <input type="text" name="prize_bond" class="form-control text-truncate personal-ntn-bottom-borders " placeholder="Prize Bond">
              @error('prize_bond')
            ...
            <div class="col-12 col-6">
              <label for="" class="form-label mb-1 mt-4 ">Cash (Number)</label>
              <input type="text" name="cash" value="{{old('cash')}}" class="form-control text-truncate personal-ntn-bottom-borders " placeholder="Cash">
              @error('cash')
              <span class="text-danger">{{$message}}</span>
              @enderror
            </div>
            ...
            <div class="col-12 col-6">
              <label for="" class="form-label mb-1 mt-4 ">Gold (Number)</label>
              <input type="text" name="gold" value="{{old('gold')}}" class="form-control text-truncate personal-ntn-bottom-borders " placeholder="Gold">
              @error('gold')
              <span class="text-danger">{{$message}}</span>
              @enderror
            </div>
            ...
            <div class="col-12 col-6">
              <label for="" class="form-label mb-1 mt-4 ">Expense during the year (number)</label>
              <input type="text" name="expense_during_the_year" value="{{old('gold')}}" class="form-control text-truncate personal-ntn-bottom-borders " placeholder="Expense during the year">
              @error('expense_during_the_year')
              <span class="text-danger">{{$message}}</span>
              @enderror
            </div>
