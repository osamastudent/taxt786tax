// <!-- this is for add new file 1 -->
    ...
    function addNewFileField() {
        ...
        deleteButton.className = 'btn float-end btn-danger delete-btn mt-2 mx-2'; // Bootstrap classes applied
    ...
    function addNewFileField2() {
        ...
        var deleteButton = document.createElement('button');
        deleteButton.type = 'button';
        deleteButton.className = 'btn float-end delete-btn btn-danger  mt-2 mx-2'; // Bootstrap classes applied
        deleteButton.innerText = 'Delete';
