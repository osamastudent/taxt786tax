...
// <!-- this is for add new file 9 -->
function AddNewFileNine() {
    document.getElementById('AddNewFile9').addEventListener('click', function () {
        addNewFileField9();
    });


    function addNewFileField9() {
        // Clone the existing file field container
        var clone = document.getElementById('cloneData9').cloneNode(true);
        ...
        // Append the cloned container with the delete button to the filesContainer
        document.getElementById('filesContainer9').appendChild(clone);
    }
