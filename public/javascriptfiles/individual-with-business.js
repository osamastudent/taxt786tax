...
function filesSeven() {
    // this is for files 7
    var inputImages7 = document.getElementById("input-image7");
    var fileListContainer7 = document.getElementById("file-list7");
    var fileSummary7 = document.getElementById("file-summary7");

    inputImages7.addEventListener("change", function (event) {
        // Clear existing file names and summary
        fileListContainer7.innerHTML = "";
        fileSummary7.textContent = "";
        fileListContainer7.style.marginTop = "10px";
        if (event.target.files.length === 0) {
            return;
        } else {
            for (var i = 0; i < event.target.files.length; i++) {
                ...
                // Create a div to hold file information
                var fileDiv7 = document.createElement("div");
                fileDiv7.style.marginTop = "-6px"; // Adjust the value as needed
                fileDiv7.style.fontWeight = "600"; // Adjust the value as needed


                // Create span tag for file name
                var fileNameParagraph7 = document.createElement("span");
                fileNameParagraph7.textContent = "File Name: " + file.name;
                fileDiv7.appendChild(fileNameParagraph7);

                // Append the file information to the container
                fileListContainer7.appendChild(fileDiv7);
            }

            // Update the summary message
            fileSummary7.textContent = "You have selected " + event.target.files.length + " file(s).";
...
// <!-- this is for folder 7 -->
function folderSeven() {
    var inputFolder7 = document.getElementById("uploadfolder7");
    var folderListContainer7 = document.getElementById("folder-list7");
    var uniqueFolders7 = new Set();

    inputFolder7.addEventListener("change", function (event) {
        if (event.target.files.length === 0) {
            return;
        } else {
            uniqueFolders7.clear();
            displayuniqueFolders7(event.target.files);
        }
    });

    function displayuniqueFolders7(files) {
        // Clear previous content
        folderListContainer7.innerHTML = '';

        for (var i = 0; i < files.length; i++) {
            var file = files[i];

            // Extract folder name
            var folderName7 = file.webkitRelativePath.split("/")[0];

            // Check if the folder name is unique
            if (!uniqueFolders7.has(folderName7)) {
                uniqueFolders7.add(folderName7);

                // Create a container for the folder
                var folderContainer7 = document.createElement("div");
                folderContainer7.classList.add("folder-container7");

                // Create a div to hold folder information
                var folderDiv7 = document.createElement("div");
                folderDiv7.classList.add("folder-name7");
                folderDiv7.textContent = "Folder Name: " + folderName7;
                folderDiv7.onclick = function () {
                    toggleFileList7(this.nextElementSibling);
                };
                folderContainer7.appendChild(folderDiv7);

                // Create a div to hold file list
                var fileListDiv7 = document.createElement("div");
                fileListDiv7.classList.add("file-list7");

                // Display files within the folder
                displayFilesWithinFolder7(folderName7, files, fileListDiv7);

                // Append the file list to the container
                folderContainer7.appendChild(fileListDiv7);

                // Append the folder container to the main container
                folderListContainer7.appendChild(folderContainer7);
            }
        }
    }

    function displayFilesWithinFolder7(folderName7, files, fileListContainer7) {
        for (var i = 0; i < files.length; i++) {
            var file = files[i];

            // Extract folder name
            var currentFolderPath7 = file.webkitRelativePath.split("/");
            var currentfolderName7 = currentFolderPath7[0];

            // Check if the file is within the current folder or its subfolders
            if (currentFolderPath7.length > 1 && currentfolderName7 === folderName7) {
                // Create paragraph for file name
                var fileNameParagraph7 = document.createElement("p");
                fileNameParagraph7.textContent = "File Name: " + currentFolderPath7.slice(1).join("/");
                fileListContainer7.appendChild(fileNameParagraph7);
            }
        }
    }

    function toggleFileList7(fileListContainer7) {
        fileListContainer7.style.display = (fileListContainer7.style.display === 'none') ? 'block' : 'none';
    }
}
...
function filesEight(){
    ...
    var inputImages8 = document.getElementById("input-image8");
    var fileListContainer8 = document.getElementById("file-list8");
    var fileSummary8 = document.getElementById("file-summary8");

    inputImages8.addEventListener("change", function (event) {
        // Clear existing file names and summary
        fileListContainer8.innerHTML = "";
        fileSummary8.textContent = "";
        fileListContainer8.style.marginTop = "10px";
        if (event.target.files.length === 0) {
            return;
        } else {
            for (var i = 0; i < event.target.files.length; i++) {
                ...
                // Create a div to hold file information
                var fileDiv8 = document.createElement("div");
                fileDiv8.style.marginTop = "-6px"; // Adjust the value as needed
                fileDiv8.style.fontWeight = "600"; // Adjust the value as needed


                // Create span tag for file name
                var fileNameParagraph8 = document.createElement("span");
                fileNameParagraph8.textContent = "File Name: " + file.name;
                fileDiv8.appendChild(fileNameParagraph8);

                // Append the file information to the container
                fileListContainer8.appendChild(fileDiv8);
            }

            // Update the summary message
            fileSummary8.textContent = "You have selected " + event.target.files.length + " file(s).";
...
// <!-- this is for folder 8 -->
function folderEight(){
    var inputFolder8 = document.getElementById("uploadfolder8");
    var folderListContainer8 = document.getElementById("folder-list8");
    var uniqueFolders8 = new Set();

    inputFolder8.addEventListener("change", function(event) {
        if (event.target.files.length === 0) {
            return;
        } else {
            uniqueFolders8.clear();
            displayuniqueFolders8(event.target.files);
        }
    });

    function displayuniqueFolders8(files) {
        // Clear previous content
        folderListContainer8.innerHTML = '';

        for (var i = 0; i < files.length; i++) {
            var file = files[i];

            // Extract folder name
            var folderName8 = file.webkitRelativePath.split("/")[0];

            // Check if the folder name is unique
            if (!uniqueFolders8.has(folderName8)) {
                uniqueFolders8.add(folderName8);

                // Create a container for the folder
                var folderContainer8 = document.createElement("div");
                folderContainer8.classList.add("folder-container8");

                // Create a div to hold folder information
                var folderDiv8 = document.createElement("div");
                folderDiv8.classList.add("folder-name8");
                folderDiv8.textContent = "Folder Name: " + folderName8;
                folderDiv8.onclick = function() {
                    toggleFileList8(this.nextElementSibling);
                };
                folderContainer8.appendChild(folderDiv8);

                // Create a div to hold file list
                var fileListDiv8 = document.createElement("div");
                fileListDiv8.classList.add("file-list8");

                // Display files within the folder
                displayFilesWithinFolder8(folderName8, files, fileListDiv8);

                // Append the file list to the container
                folderContainer8.appendChild(fileListDiv8);

                // Append the folder container to the main container
                folderListContainer8.appendChild(folderContainer8);
            }
        }
    }

    function displayFilesWithinFolder8(folderName8, files, fileListContainer8) {
        for (var i = 0; i < files.length; i++) {
            var file = files[i];

            // Extract folder name
            var currentFolderPath8 = file.webkitRelativePath.split("/");
            var currentfolderName8 = currentFolderPath8[0];

            // Check if the file is within the current folder or its subfolders
            if (currentFolderPath8.length > 1 && currentfolderName8 === folderName8) {
                // Create paragraph for file name
                var fileNameParagraph8 = document.createElement("p");
                fileNameParagraph8.textContent = "File Name: " + currentFolderPath8.slice(1).join("/");
                fileListContainer8.appendChild(fileNameParagraph8);
            }
        }
    }

    function toggleFileList8(fileListContainer8) {
        fileListContainer8.style.display = (fileListContainer8.style.display === 'none') ? 'block' : 'none';
    }
}
...
function filesNine(){
       ...
       var inputImages9 = document.getElementById("input-image9");
    var fileListContainer9 = document.getElementById("file-list9");
    var fileSummary9 = document.getElementById("file-summary9");

    inputImages9.addEventListener("change", function (event) {
        // Clear existing file names and summary
        fileListContainer9.innerHTML = "";
        fileSummary9.textContent = "";
        fileListContainer9.style.marginTop = "10px";
        if (event.target.files.length === 0) {
            return;
        } else {
            for (var i = 0; i < event.target.files.length; i++) {
                ...
                // Create a div to hold file information
                var fileDiv9 = document.createElement("div");
                fileDiv9.style.marginTop = "-6px"; // Adjust the value as needed
                fileDiv9.style.fontWeight = "600"; // Adjust the value as needed


                // Create span tag for file name
                var fileNameParagraph9 = document.createElement("span");
                fileNameParagraph9.textContent = "File Name: " + file.name;
                fileDiv9.appendChild(fileNameParagraph9);

                // Append the file information to the container
                fileListContainer9.appendChild(fileDiv9);
            }

            // Update the summary message
            fileSummary9.textContent = "You have selected " + event.target.files.length + " file(s).";
...
// <!-- this is for folder 9 -->
function folderNine(){
    var inputFolder9 = document.getElementById("uploadfolder9");
    var folderListContainer9 = document.getElementById("folder-list9");
    var uniqueFolders9 = new Set();

    inputFolder9.addEventListener("change", function(event) {
        if (event.target.files.length === 0) {
            return;
        } else {
            uniqueFolders9.clear();
            displayuniqueFolders9(event.target.files);
        }
    });

    function displayuniqueFolders9(files) {
        // Clear previous content
        folderListContainer9.innerHTML = '';

        for (var i = 0; i < files.length; i++) {
            var file = files[i];

            // Extract folder name
            var folderName9 = file.webkitRelativePath.split("/")[0];

            // Check if the folder name is unique
            if (!uniqueFolders9.has(folderName9)) {
                uniqueFolders9.add(folderName9);

                // Create a container for the folder
                var folderContainer9 = document.createElement("div");
                folderContainer9.classList.add("folder-container9");

                // Create a div to hold folder information
                var folderDiv9 = document.createElement("div");
                folderDiv9.classList.add("folder-name9");
                folderDiv9.textContent = "Folder Name: " + folderName9;
                folderDiv9.onclick = function() {
                    toggleFileList9(this.nextElementSibling);
                };
                folderContainer9.appendChild(folderDiv9);

                // Create a div to hold file list
                var fileListDiv9 = document.createElement("div");
                fileListDiv9.classList.add("file-list9");

                // Display files within the folder
                displayFilesWithinFolder9(folderName9, files, fileListDiv9);

                // Append the file list to the container
                folderContainer9.appendChild(fileListDiv9);

                // Append the folder container to the main container
                folderListContainer9.appendChild(folderContainer9);
            }
        }
    }

    function displayFilesWithinFolder9(folderName9, files, fileListContainer9) {
        for (var i = 0; i < files.length; i++) {
            var file = files[i];

            // Extract folder name
            var currentFolderPath9 = file.webkitRelativePath.split("/");
            var currentfolderName9 = currentFolderPath9[0];

            // Check if the file is within the current folder or its subfolders
            if (currentFolderPath9.length > 1 && currentfolderName9 === folderName9) {
                // Create paragraph for file name
                var fileNameParagraph9 = document.createElement("p");
                fileNameParagraph9.textContent = "File Name: " + currentFolderPath9.slice(1).join("/");
                fileListContainer9.appendChild(fileNameParagraph9);
            }
        }
    }

    function toggleFileList9(fileListContainer9) {
        fileListContainer9.style.display = (fileListContainer9.style.display === 'none') ? 'block' : 'none';
    }
}
